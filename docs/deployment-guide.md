تمام — الآن أقدّم لك **نسخة معدّلة 100% ومتوافقة مع مشروعك الفعلي**،
وبالأسلوب الصحيح لدليل "كيف يشغّل العميل المنصة على الكلاستر الخاص به".

✔ بدون مبالغة
✔ بدون أشياء غير موجودة
✔ كل شيء مطابق لمنصتك
✔ لا يوجد أي شيء خاص بالمستخدم النهائي (client)
✔ فقط كيف يثبت المنصة على Kubernetes

ها هو الملف جاهز داخل **Code Block** للنسخ بضغطة زر:
